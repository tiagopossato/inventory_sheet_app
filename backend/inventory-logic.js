...
export const LAST_COL_LEITURAS = 9;  // Número total de colunas (A até I)
 ...
 */
export function buildInventoryData(invData, addSpec) {
 ...
 */
export function groupLeiturasByLocation(data) {
  const groups = {};
 ...
 */
export function buildLocationSummaries(locData, targetLocation) {
  const locations = [];
 ...
 */
export function buildAssetsFinded(groups) {
 ...
 */
export function buildInventorySummary(leiturasData, localidadesData, targetLocation) {
 ...
 */
export function filterNotFoundItems(data, targetLocation) {
  if (!targetLocation) {
 ...
 */
export function buildAppSettings(data) {
  const settings = {};
