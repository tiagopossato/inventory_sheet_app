...
export const COL_INV_LOCATION = 0; // Coluna D — Nome da localidade
export const COL_INV_ASSET = 2; // Coluna F — Número de tombamento
export const COL_INV_SPECNAME = 8; // Coluna L — Nome da especificação
export const SPEC_NAME_MAX_LEN = 140; // Limite de caracteres para specName

/** Índices base 0 a partir da coluna B da aba "leituras" */
export const COL_LEITURAS_CODE = 1; // Coluna C — Código do bem
export const COL_LEITURAS_LOC = 2; // Coluna D — Localidade
export let LAST_COL_LEITURAS = 9; //Número total de colunas na aba "leituras" (A até I).

/** Índices base 0 da aba "nao_encontrados_geral" */
export const COL_NOTFOUND_LOC = 0; // Coluna A — Localidade
export const COL_NOTFOUND_ASSET = 1; // Coluna B — Tombamento
 ...
 */
export function buildInventoryData_(invData, addSpec) {
 ...
 */
export function groupLeiturasByLocation_(data) {
  const groups = {};
 ...
 */
export function buildLocationSummaries_(locData, targetLocation) {
  const locations = [];
 ...
 */
export function buildAssetsFinded_(groups) {
 ...
 */
export function buildInventorySummary_(leiturasData, localidadesData, targetLocation) {
 ...
 */
export function filterNotFoundItems_(data, targetLocation) {
  if (!targetLocation) {
 ...
 */
export function buildAppSettings_(data) {
  const settings = {};
